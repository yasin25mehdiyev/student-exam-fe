  ...
  template: `
    ...
    >
      ...
      <ng-icon
        ...
        class="text-muted-foreground text-[length:--spacing(4)] ms-auto transition-transform"
        [class.rotate-180]="_select.isExpanded()"
      />
    </button>
  `,
})
export class HlmSelectTrigger {
  ...
  protected readonly _select = inject(BrnSelect);
